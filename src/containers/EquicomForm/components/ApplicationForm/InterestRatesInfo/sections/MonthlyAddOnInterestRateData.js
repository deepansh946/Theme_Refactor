var obj = [
	'Processing Fee (to be deducted from loan proceeds):PhP 1,500.00 for		employed and PhP 2,000.00 for self-employed',

	' Documentary Stamps Tax of PhP 1.50 for every PhP 200.00 onlu for loans PhP250,000.00 and above (effective january 1,2018)',

	'Late Payment Fee:3.0% per month of the total overdue amount or Php500.00, whichever is higher',

	'Early Settlement Fee: 5.0% of the remaining principal balance or PhP500.00,whichever is higher',

	'Return Check Fee:PhP500.00 per returned check',

	'Extension Fee: PhP500.00',

	'Credit to Non-EqB Account Fee:P15.00',
];
export default obj;
...
/* var obj = {
	tier2: [
		{
			effectiveyield: "Tier 2",
			term: ["12 months", "18 months", "24 months", "36 months", "48 months"],
			addonrate: ["1.55 %", "1.65 %", "1.65 %", "1.75 %", "1.85%"],
			factorrate: ["0.09883", "0.07206", "0.05817", "0.04528", "0.03933"],
		},
		{
			effectiveyield: "Tier 3",
			term: ["12 months", "18 months", "24 months"],
			addonrate: ["2.50%"],
			factorrate: ["0.10833", "0.08055", "0.06666", "0.05277"],
		},
		{
			effectiveyield: "Tier 2",
			term: ["23 months"],
...
// var tier2 = {
//   "effective yield": "Tier 2",
//   term: ["12 months", "18 months", "24 months", "36 months", "48 months"],
//   "add on rate": ["1.55 %", "1.65 %", "1.65 %", "1.75 %", "1.85%"],
//   "factor rate": ["0.09883", "0.07206", "0.05817", "0.04528", "0.03933"]
// };
